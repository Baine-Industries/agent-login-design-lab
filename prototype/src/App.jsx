...
function VaultApp() {
  ...
  return (
    <div className={`app-shell ${darkMode ? "is-dark" : ""}`} style={{ "--type-scale": typeScale }}>
      ...
      {editItem && <EditItemModal item={editItem} spaces={spaces} categoryOptions={categoryOptions.filter((category) => category !== "All items")} reusableFields={reusableFields} onSave={saveItem} onClose={() => setModal(null)} />}
    </div>
  );
}
...
function EditItemModal({ item, spaces, categoryOptions, reusableFields, onSave, onClose }) {
