  ...
  return (
    <div className={`app-shell ${darkMode ? "is-dark" : ""}`} style={{ "--type-scale": typeScale }}>
      ...
      <aside className="inspector" aria-label="Selected Vault Item">
        ...
        <section className="inspector-section"><div className="section-title"><span>CORE INFO</span><span className="source-label"><span className="source-dot" /> {selectedItemSpace?.name}</span></div><div className="core-info-callout"><Icon name="ph-arrows-clockwise" size={18} /><div><strong>Reusable by default</strong><span>These values come from this Vault Space.</span></div></div><FieldRow label="Full name" value={coreInfo.fullName} inherited /><FieldRow label="Email" value={coreInfo.email} inherited /><FieldRow label="Address" value={coreInfo.address} inherited /></section>
