...
Issues and Wayfinder decisions for this repo live in GitHub Issues at `Baine-Industries/agent-login-design-lab`.
...
The local `.scratch/agent-vault-frontend/` files are a reviewable mirror and offline fallback, not the shared source of truth while GitHub is writable.
